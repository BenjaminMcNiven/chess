...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_YELLOW_LIGHT = SET_BG_COLOR + "228m";  // bright but soft yellow
    public static final String SET_BG_COLOR_YELLOW_DARK = SET_BG_COLOR + "226m";// more muted, still readable
    public static final String SET_BG_COLOR_LIGHT_RED = SET_BG_COLOR + "204m";  // light red background
